...
const divider = (): MenuItem => ({
  ...DIVIDER,
  key: `__div_${Math.random().toString(36).slice(2)}__`,
});
...
function buildFolderMenu(_ctx: MenuContext): MenuItem[] {
  return [
    {
      key: 'goto',
      label: 'Go To',
    ...
    },
    {
      ...
      label: 'Create New',
      icon: 'PlusOutlined',
      requiredPermission: 'createElement',
    },
    {
      key: 'import',
      label: 'Import',
...
function buildElementMenu(_ctx: MenuContext): MenuItem[] {
  return [
    {
      key: 'goto',
      label: 'Go To',
    ...
    },
    {
      ...
      label: 'Connect',
      icon: 'ApiOutlined',
      requiredPermission: 'createRelationship',
    },
    {
      key: 'add-sub-component',
      label: 'Add Sub-Component',
      icon: 'SubnodeOutlined',
      requiredPermission: 'createElement',
    },
    {
      key: 'add-from-template',
    ...
    divider(),
    {
      key: 'create-drilldown',
      label: 'Create Drill-Down Diagram',
      icon: 'PartitionOutlined',
      requiredPermission: 'createView',
    },
    {
      key: 'change-parent',
      label: 'Change Parent',
      icon: 'DragOutlined',
      requiredPermission: 'editElement',
    },
    { key: 'copy', label: 'Copy', icon: 'CopyOutlined', shortcut: 'Ctrl+C' },
    {
      ...
      label: 'Delete',
      icon: 'DeleteOutlined',
      requiredPermission: 'deleteElement',
      shortcut: 'Del',
      danger: true,
    },
    {
    ...
    {
      key: 'change-sync-target',
      label: 'Change Sync Target',
      icon: 'LinkOutlined',
    },
    {
...
function buildDiagramMenu(_ctx: MenuContext): MenuItem[] {
  return [
    {
      key: 'open-view',
      label: 'Open',
...
function buildDefaultExplorerMenu(_ctx: MenuContext): MenuItem[] {
  return [{ key: 'refresh', label: 'Refresh', icon: 'ReloadOutlined' }];
}
...
function canvasElementProvider(_ctx: MenuContext): MenuItem[] {
  return [
    {
...
function canvasEmptySpaceProvider(_ctx: MenuContext): MenuItem[] {
  return [
    {
      key: 'create-element',
...
function gridRowProvider(_ctx: MenuContext): MenuItem[] {
  return [
    {
      key: 'open-row',
      label: 'Open',
...
function diagramTabProvider(_ctx: MenuContext): MenuItem[] {
  return [
...
function inspectorProvider(_ctx: MenuContext): MenuItem[] {
  return [
    {
      key: 'copy-value',
      label: 'Copy Value',
